...
# =========================================================================
# [1/2] ZENQ OPTIMIZER (NETWORK, SYSTEM, MOUSE & GRAPHICS)
# =========================================================================
Write-Host "[1/2] Applying Gaming Optimizations..." -ForegroundColor Yellow
...
# =========================================================================
# [2/2] CLEAR HISTORY & CLEANUP
# =========================================================================
Write-Host "[2/2] Clearing Powershell & Windows History..." -ForegroundColor Yellow
...
Write-Host ""
Write-Host "All Optimizations & History Cleaned Successfully!" -ForegroundColor Green
Write-Host "Please restart your PC for changes to take effect." -ForegroundColor Cyan
